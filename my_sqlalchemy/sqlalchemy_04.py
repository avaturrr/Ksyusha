...
insert_book = (f"insert into Book (title, pages, author, price, release_year) values ({title_user}, {pages_user}, {author_user}, {price_user}, {release_year_user});")
query = text(insert_book)
